...
void SSD1306_rotate(unsigned char * rawBit, unsigned char * destBit, size_t pixelCount)
{
...
void SSD1306_setPos(int x, int y)
{
    ...
    SSD1306_sendCommand((x&0x0f));
}

void SSD1306_fillData(unsigned char * data)
{
    unsigned int j=0;
    unsigned char x,y;
